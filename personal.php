...
<div class="col-md-6">
  ...
  <table class="table align-middle">
    ...
    <tr>
        ...
        <td>Sucursal 2</td>
        <td>
            <a href="editarPersonal.php?id=3" class="btn btn-sm btn-outline-primary">
                <i class="bi bi-pencil-square"></i>
            </a>
        </td>
    </tr>
    <tr>
        ...
        <td>Sucursal 1</td>
        <td>
            <a href="editarPersonal.php?id=4" class="btn btn-sm btn-outline-primary">
                <i class="bi bi-pencil-square"></i>
            </a>
        </td>
    </tr>
     <tr>
        ...
        <td>Sucursal 3</td>
        <td>
            <a href="editarPersonal.php?id=5" class="btn btn-sm btn-outline-primary">
                <i class="bi bi-pencil-square"></i>
            </a>
        </td>
    </tr>
    <tr>
        ...
        <td>Sucursal 2</td>
        <td>
            <a href="editarPersonal.php?id=6" class="btn btn-sm btn-outline-primary">
                <i class="bi bi-pencil-square"></i>
            </a>
        </td>
    </tr>
